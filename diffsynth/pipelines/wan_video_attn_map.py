...
class WanVideoPipeline_attn(BasePipeline):
    ...
    def fetch_models(self, model_manager: ModelManager):
        ...
        self.dit = model_manager.fetch_model("wan_video_dit_attn")
    ...
    def from_model_manager(model_manager: ModelManager, torch_dtype=None, device=None):
        ...
        pipe = WanVideoPipeline_attn(device=device, torch_dtype=torch_dtype)
