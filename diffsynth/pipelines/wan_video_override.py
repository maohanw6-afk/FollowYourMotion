...
class WanVideoPipeline_Override(BasePipeline):
    ...
    def __init__(self, device="cuda", torch_dtype=torch.float16, tokenizer_path=None):
        ...
        self.dit: WanModel_override = None
    ...
    def fetch_models(self, model_manager: ModelManager):
        ...
        self.dit = model_manager.fetch_model("wan_video_dit_override")
    ...
    def from_model_manager(model_manager: ModelManager, torch_dtype=None, device=None):
        ...
        pipe = WanVideoPipeline_Override(device=device, torch_dtype=torch_dtype)
